...
# @author Gabor Soter
# 
# @videomapping YUYV 320 240 30 YUYV 320 240 30 Skinflow Skinflow
# @email gabor.soter@bristol.ac.uk
# @address 123 first street, Los Angeles CA 90012, USA
# @copyright Copyright (C) 2018 by Gabor Soter
# @mainurl 
# @supporturl 
# @otherurl 
# @license GPL v3
...
class Skinflow:
    ...
    def process(self, inframe, outframe):
        ...
        # Write a title:
        cv2.putText(outimg, "JeVois Skinflow", (3, 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,255,255))
